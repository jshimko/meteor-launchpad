...
ONBUILD ARG PRE_INSTALL_SCRIPT
ONBUILD ENV PRE_INSTALL_SCRIPT $PRE_INSTALL_SCRIPT
...
ONBUILD COPY ./$PRE_INSTALL_SCRIPT $BUILD_SCRIPTS_DIR
ONBUILD RUN if [ "$PRE_INSTALL_SCRIPT" ]; then $BUILD_SCRIPTS_DIR/$PRE_INSTALL_SCRIPT; fi
